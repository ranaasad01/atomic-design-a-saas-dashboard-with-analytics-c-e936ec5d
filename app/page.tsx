            ...
            {pricingPlans.map((plan) => (
              <motion.div
                ...
                className={`relative rounded-2xl p-7 transition-all duration-300 ${
                  plan.highlighted
                    ? "bg-gradient-to-b from-indigo-600/20 to-violet-600/10 border-2 border-indigo-500/50 shadow-2xl shadow-indigo-500/20"
                    : "bg-slate-900/60 border border-slate-800/60 hover:border-slate-700/80"
                }`}
              >
                {plan.highlighted && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 text-white text-xs font-bold shadow-lg">
      ...
      <section className="py-20 lg:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-80px" }}
            className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-indigo-600/30 via-violet-600/20 to-cyan-600/10 border border-indigo-500/30 p-12 lg:p-16 text-center shadow-2xl shadow-indigo-500/10"
          >
            {/* Glow blobs */}
            ...
            <div className="relative z-10">
              <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-indigo-300 text-sm font-medium mb-6">
              ...
              >
                Join 2,400+ SaaS teams who replaced their spreadsheets and fragmented
                tools with Pulse. Set up in under 5 minutes.
              </motion.p>
              <motion.div
                variants={fadeInUp}
                className="flex flex-col sm:flex-row items-center justify-center gap-4"
              >
                <Link href="/dashboard">
                  <motion.span
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-indigo-700 font-bold text-base shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-pointer"
                  >
                    Get started free
                    <ArrowRight className="w-4 h-4" />
                  </motion.span>
                ...
                <Link href="/analytics">
                  <motion.span
                    whileHover={{ scale: 1.04, y: -2 }}
                    whileTap={{ scale: 0.97 }}
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white/5 border border-white/15 text-white font-semibold text-base hover:bg-white/10 transition-all duration-200 cursor-pointer"
                  >
                    See live demo
                  </motion.span>
                </Link>
